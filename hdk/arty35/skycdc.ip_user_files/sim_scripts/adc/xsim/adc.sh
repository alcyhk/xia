...
#
# Generated by Vivado on Tue Dec 27 18:07:03 HKT 2022
...
# Script info
echo -e "adc.sh - Script generated by export_simulation (Vivado v2021.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot adc xil_defaultlib.adc xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim adc -key {Behavioral:sim_1:Functional:adc} -tclbatch cmd.tcl -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/home/albert/tools/Xilinx/Vivado/2021.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
